  ...
  return (
    <div className="w-full">
      ...
      <Hero
        ...
        description="Dokumentasi kegiatan dan momen berharga HMPS Perbankan Syariah"
        showScroll={false}
      />
        ...
        <div className="container-fluid">
          {images.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-muted-foreground text-base sm:text-lg">Belum ada foto yang dipublikasikan.</p>
            </div>
          ) : (
