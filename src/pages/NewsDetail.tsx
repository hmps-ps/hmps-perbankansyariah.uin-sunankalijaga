    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center px-4">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Berita Tidak Ditemukan</h1>
          <Link to="/news">
            <Button>
      ...
      <article className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-card rounded-2xl overflow-hidden shadow-medium">
          ...
          <div className="p-6 sm:p-8 md:p-12">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-card-foreground mb-6 sm:mb-8">
              {news.title}
            </h1>

            <div className="prose prose-lg max-w-none">
              <div className="text-card-foreground text-sm sm:text-base leading-relaxed whitespace-pre-line">
                {news.content}
              </div>
            </div>
          </div>
